...
var _0x1022 = ['parse', 'parame "str" is not a string', 'Utf8', 'parame "iv" is not a string', 'string', 'enc', 'AES', 'Base64', 'stringify', 'toString', 'decrypt', 'pad', 'Pkcs7'];
...
var AES = {
    'encrypt': (_0x4976f6, _0x387e2b, _0x5a8811) => {
        if (typeof _0x4976f6 != _0x5722('0x4')) {
            throw new Error('parame "str" is not a string');
        }
        if (typeof _0x387e2b != _0x5722('0x4')) {
            throw new Error('parame "key" is not a string');
        }
