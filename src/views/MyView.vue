    ...
    <div class="my">
        ...
        <div class="my-con">
            <div class="info" @click="onGo('/setinfo')">
                <div class="info-left">
                    <div>
                        <img :src="memberInfo?.memberAvatar || defaultAvatar" alt="头像" style="width: 82px;height: 82px;border-radius: 10px;" />
                    </div>
                    <div class="info-u">
                        <div>
                ...
                <div class="flex-b" @click.stop>
                    <div class="block">
                        <div class="header">
                            ...
                            <div class="flex-h-h">
                                <div class="img"> <img src="@/assets/Image/logo.png"
...
import oo1 from "@/assets/my/me/01.png";
import oo2 from "@/assets/my/me/02.png";
import oo3 from "@/assets/my/me/03.png";
import oo4 from "@/assets/my/me/04.png";
